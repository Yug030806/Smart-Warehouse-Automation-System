...
export default function VehiclesPage() {
  ...
  const loadVehicles = () => {
    ...
    const fls = supabase.from('floors').select().data || [];
    ...
    const tsk = supabase.from('tasks').select().data || [];
      ...
      <div className="flex-grow flex flex-col min-w-0">
        ...
        <main className="p-8 space-y-8 overflow-y-auto flex-1">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-slate-100">Vehicle Fleet Roster</h1>
              <p className="text-sm text-slate-400">Manage autonomous carts, view battery charges, assign locations and monitor tasks.</p>
            </div>
            <button
              onClick={() => {
