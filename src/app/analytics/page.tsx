      ...
      <div className="flex-grow flex flex-col min-w-0">
        ...
        <main className="p-8 space-y-8 overflow-y-auto flex-1">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-slate-100">System Performance Analytics</h1>
              <p className="text-sm text-slate-400">Review fleet logistics efficiency, delivery times, and payload priority statistics.</p>
            </div>
