    ...
    <div className="flex min-h-screen bg-slate-950">
      ...
      <div className="flex-grow flex flex-col min-w-0">
        ...
        <main className="p-8 space-y-8 overflow-y-auto flex-1">
          <div>
            <h1 className="text-2xl font-bold text-slate-100">System Config & Simulation Controls</h1>
            <p className="text-sm text-slate-400">Configure global movement speeds, transitions, automation defaults and reset seed data.</p>
          </div>
